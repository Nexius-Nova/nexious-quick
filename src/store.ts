...
import { DEFAULT_SETTINGS, SEARCH_ENGINES, accentTheme, type AppSettings, type Item, type ItemType, type ThemeMode } from './types'
...
function applySettings(map: Record<string, string>) {
  ...
  Object.assign(store.settings, {
    ...
    hoverShow: s.hoverShow === 'true',
    showIcons: s.showIcons !== 'false',
    autoSyncApps: s.autoSyncApps !== 'false',
    enabledWebsites: s.enabledWebsites !== 'false',
    enabledFolders: s.enabledFolders !== 'false',
